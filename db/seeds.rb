ActiveRecord::Base.connection.disable_referential_integrity do
  ...
  i1 = Item.create({name: "Apple", description: "Delicious granny smith apple", origin: "sydney", min_order: 1, price: 3.99, item_image: "", user_id: u2.id})
  i2 = Item.create({name: "Banana", description: "Sweet lady finger banana", origin: "melbourne", min_order: 1, price: 2.99, item_image: "", user_id: u2.id})
  i3 = Item.create({name: "Orange", description: "Navel Orange", origin: "gold coast", min_order: 1, price: 9.99, item_image: "", user_id: u3.id})
  i4 = Item.create({name: "Pineapple", description: "Super Pineapple", origin: "perth", min_order: 1, price: 19.99, item_image: "", user_id: u3.id})
